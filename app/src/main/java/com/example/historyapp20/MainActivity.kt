package com.example.historyapp20
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //This is where i put the code to find the buttons and the edittext and textview
        ...
        search?.setOnClickListener {
            ...
            if (inputText.isNotEmpty() && inputText.all { it.isDigit() }) {
                ...
                //Below is where i start the lines of code for the ages
